"""Read ESRI shapefiles into GeoJSON geometries (WGS84), reprojecting as needed.

Self-contained copy of moeds's gis/shapefile_utils.py — report_moe owns the GIS
feature tables it imports into (see enforce_single_writer.sql), so this import
tooling lives here rather than depending on the sibling moeds project.
"""
